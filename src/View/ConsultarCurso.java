...
public class ConsultarCurso extends javax.swing.JFrame {
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
       int teste = Integer.parseInt(jTextField1.getText());
       
       CursoDB curso = new CursoDB();
       ResultSet test = null;
        try {
            test = curso.Consulta(teste);
            new DetalheCurso(teste).setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(ConsultarCurso.class.getName()).log(Level.SEVERE, null, ex);
        }
